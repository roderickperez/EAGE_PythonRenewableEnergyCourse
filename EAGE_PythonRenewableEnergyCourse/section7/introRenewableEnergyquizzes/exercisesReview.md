...
def functionCelsiusToFahrenheit(C):
    """
    Convert degrees *Celsius* to degrees *Fahrenheit*, and return the value of $°F$
    """
    F = C * (9/5) + 32
    return F
# 2) Call the function:
print(functionCelsiusToFahrenheit(20))
```
:::
...
C = float(input("Input a temperature value in degrees Celsius?"))

# Use this input in the function defined in Exercise 2
print(functionCelsiusToFahrenheit(C))
```
